...
import { Button, Card, Input, Select, theme, Grid } from "antd";
...
const DiscountFiltersCard: React.FC<Props> = ({
  params,
  setParams,
  pagination,
  handleTableChange,
      ...
      {isMobile ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            <span style={{ fontSize: 12, color: token.colorTextDescription }}>Show</span>
            <Select<number>
            ...
            />
            <span style={{ fontSize: 12, color: token.colorTextDescription }}>entries</span>
          </div>
...
export default DiscountFiltersCard;
